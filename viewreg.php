...
<form action="process/user_reg.php" method="post" enctype="multipart/from-data">
  ...
  <div class="image-upload-wrap form-group">
    ...
    <input class="file-upload-input form-control" type="file" onchange="readURL(this)" accept="image/*" name="imgg" id="imgg">
  </div>
  <div class="form-group">
...
<form action="process/user_reg.php" method="post" enctype="multipart/from-data" >
  ...
  <h1>xxxxxxxxxxxxxxxxxxxxxxxxxx</h1>
  <h1><font color="red"><?php echo"$_REQUEST[msg]";?></h1></font></h1>
  <h1>Your chat id-<font color="red"><?php echo"$_REQUEST[chatid]";?></font></h1>
 <h1>Email id-<font color="red"><?php echo"$_REQUEST[email]";?></font></h1>
  <h1>Password-<font color="red"><?php echo"$_REQUEST[pass]";?></font></h1>
  <h1><font color="red">Please note your email and password,it is required for login </font></h1>
  <h1><font color="red">Thank you for registration......please use this website and give feedback</font></h1>
